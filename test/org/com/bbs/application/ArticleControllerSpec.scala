...
import common.{FakeAppHelper, TestDBHelper}
...
class ArticleControllerSpec extends PlaySpecification with FakeAppHelper with ResultExtractors with Mockito with TestDBHelper{
  running(fakeApp) {
