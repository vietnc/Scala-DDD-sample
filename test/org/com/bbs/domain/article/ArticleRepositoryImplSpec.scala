package org.com.bbs.domain.article
import common.FakeAppHelper
import org.specs2.mock.Mockito
import play.api.test._
import org.com.bbs.domain.model.article.{Article, ArticleRepositoryImpl}
  ...
  "ArticleRepository " should{
    ...
    "store(article): " in{
      "return false if save not successfull " in {
        ...
        (repo.store(ArticleDomainService.toEntity(dtoArticleTest))) must equalTo(Success(false))
      }
    }
