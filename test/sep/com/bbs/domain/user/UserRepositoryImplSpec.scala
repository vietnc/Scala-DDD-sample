package sep.com.bbs.domain.user

import common.FakeAppHelper
import org.specs2.mock.Mockito
import play.api.test.PlaySpecification
import sep.com.bbs.domain.model.user.UserRepositoryImpl
  ...
  "UserRepository " should{
    "findByEmail: " in {
      ...
      "existed email in db return User object" in {
        ...
        repo.findByEmail(dtoUserTest.email).get.getOrElse(None) must equalTo(UserDomainService.loadDTO(dtoUserTest))
      }
